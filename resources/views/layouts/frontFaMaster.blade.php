...
<head>
    ...
    <meta property="og:site_name" content="شرکت معماری ساروج"/>
    ...
    <link rel="stylesheet" href="{{asset("Front Assets/css/FA/MainFa.css")}}">
...
<section class="main">
    ...
    <header class="MenuBgLight dark:menuBgDark">
        <div class="logo">
            <div class="hamburger">
                <svg class="svgOption dark:svgOptionDark hover:svgOptionHover dark:hover:svgOptionHover" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav class="dk">
            <ul>
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.index")}}">خانه</a></li>
                <li>
                    <a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.projects")}}">
                        پروژه ها
                    </a>
                        ...
                        <ul>
                            @foreach($category as $item)
                                <li class="bg-[#FCFCFD] dark:bg-[#0E0E0E]">
                                    <a class="text-[black] dark:text-[#F1F1F2]" href="{{route("projects.category",["category"=>$item->nameFa])}}">{{$item->nameFa}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                @endphp
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.index")}}#service">خدمات</a></li>
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.index")}}#faq">سوالات متداول</a></li>
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.index")}}#team">اعضا</a></li>
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.about")}}">درباره ما</a></li>
            </ul>
        </nav>
        <nav class="mb bg-[#FFFFFF] dark:bg-[black]">
            ...
            <ul>
                <li><a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("homeEn.index")}}">خانه</a></li>
                <li id="psj">
                    <a class="text-[black] dark:text-[#F1F1F2] dark:hover:text-[#AE8649]" href="{{route("home.projects")}}">پروژه ها</a>
        ...
        <div class="options">
            <div class="language">
                <span class="text-[black] dark:text-[#F1F1F2]">فارسی</span>
