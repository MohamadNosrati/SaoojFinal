                    ...
                    <main>
                        <div class="containerBf">
                            <div class="imageContainer">
                                <span class="before">قبل</span>
                                <span class="after">بعد</span>
                                <img class="imageBefore sliderImage" src="{{asset("images/bf/".$bf->imageBefore)}}"
                                     alt="{{$bf->altBeforeEn}}"/>
                                <img class="imageAfter sliderImage" src="{{asset("images/bf/".$bf->imageAfter)}}"
                                     alt="{{$bf->altAfterEn}}"/>
                            </div>
