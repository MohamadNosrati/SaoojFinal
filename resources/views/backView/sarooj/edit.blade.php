...
@section("contentBack")
    <div class="col-12 my-5">
        ...
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            {!! Form::model($sarooj,["route"=>["sarooj.update","id"=>$sarooj->id],"method"=>"put","files"=>true]) !!}
            <div class="text-center">
                <img style="width: 125px;height: 125px;border-radius: 50%;object-fit: cover" src="{{asset("images/sarooj/".$sarooj->logo)}}">
            </div>
