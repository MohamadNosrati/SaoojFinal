...
@section("titleBack","Bf Create")
@section("contentBack")
    <div class="col-12 my-5">
        <h1 class="text-white text-center text-capitalize mb-3">Bf create</h1>
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            {!! Form::open(["route"=>"bf.store","method"=>"post","files"=>true]) !!}
            ...
            {!! Form::select("project",$project,null,["class"=>"form-select mb-3 text-capitalize"]) !!}
            @error("info_id")
            <p class="text-danger my-3 text-capitalize">{{$message}}</p>
            @enderror
