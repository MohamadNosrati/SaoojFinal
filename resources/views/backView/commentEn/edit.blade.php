...
@section("titleBack","English comment Edit")
@section("contentBack")
    <div class="col-12 my-5">
        ...
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            {!! Form::model($comment,["route"=>["commentEn.update","id"=>$comment->id],"method"=>"put","files"=>true]) !!}
        ...
        <div class="text-center">
            <a class="btn btn-info text-white text-capitalize mt-3" href="{{route("commentEn.index")}}">details English Comments</a>
        </div>
    </div>
@endsection
