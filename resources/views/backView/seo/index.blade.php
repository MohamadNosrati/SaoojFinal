...
@section("titleBack","Seo Index")
@section("contentBack")
    <div class="col-12 my-5 text-center mx-auto">
        <h1 class="text-white text-center text-capitalize mb-3">Seo details</h1>
            ...
            <table class="table table-dark table-responsive text-white rounded-3 px-2 py-4">
                ...
                @foreach($seo as $item)
                    <tr>
                        ...
                        <td style="line-height: 120px">{{mb_strcut($item->title,0,20)}}</td>
                        <td style="line-height: 120px">{{mb_strcut($item->description,0,20)}}</td>
                        <td style="line-height: 120px">{{mb_strcut($item->keywords,0,25)}}</td>
                        <td style="line-height: 120px">{{mb_strcut($item->author,0,25)}}</td>
                        ...
                        <td style="line-height: 120px">
                            <a class="btn btn-warning text-capitalize text-white" href="{{route("seo.edit",["id"=>$item->id])}}">update</a>
                        </td>
                    </tr>
                @endforeach
            </table>
        ...
        @endif
        <a class="btn btn-success text-white text-capitalize mt-5" href="{{route("seo.create")}}">create seo</a>
    </div>
@endsection
