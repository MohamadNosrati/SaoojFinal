...
@section("titleBack","Service Create")
@section("contentBack")
    <div class="col-12 my-5">
        <h1 class="text-white text-center text-capitalize mb-3">service create</h1>
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            ...
            {!! Form::select("publish",[1=>"Active",0=>"DeActive"],1,["class"=>"form-select mb-3"]) !!}
        ...
        <div class="text-center">
            <a class="btn btn-info text-white text-capitalize mt-3" href="{{route("service.index")}}">details service</a>
        </div>
    </div>
@endsection
