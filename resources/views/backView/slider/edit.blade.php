...
@section("contentBack")
    <div class="col-12 my-5">
        <h1 class="text-white text-center text-capitalize mb-3">slider edit</h1>
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            ...
            <div class="text-center">
                <img style="width: 125px;height: 125px;border-radius: 50%;object-fit: cover" src="{{asset("images/slider/".$slider->image)}}" alt="">
            </div>
            ...
            {!! Form::select("publish",[1=>"Active",0=>"DeActive"],$slider->publish,["class"=>"form-select mb-3"]) !!}
