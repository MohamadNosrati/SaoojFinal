...
@section("titleBack","Info Create")
@section("contentBack")
    <div class="col-12 my-5">
        <h1 class="text-white text-center text-capitalize mb-3">info create</h1>
        <div class="col-8 mx-auto my-4 bg-dark py-4 px-5 rounded-4">
            ...
            {!! Form::number("videoId",old("videoId"),["class"=>"form-control mb-3 text-capitalize","placeholder"=>"Please Enter Your Video Id"]) !!}
            @error("videoId")
            ...
            {!! Form::select("project_id",$project,null,["class"=>"form-select mb-3"]) !!}
            @error("project_id")
            <p class="text-danger my-3 text-capitalize">{{$message}}</p>
            @enderror
